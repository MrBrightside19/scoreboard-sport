...
import type { TeamPenalty } from '@/sports/scoreboardState'
...
const sportModule = computed(() => getSportModule(store.state.sport))
const maxPeriods = computed(() => sportModule.value.clock.periods)
...
function penaltySignature(
  penalties: import('@/sports/scoreboardState').TeamPenalty[],
): string {
  return penalties
    .map((penalty) =>
  ...
  >
    <template #links>
      ...
      <a-tabs v-model:active-key="activeTab" class="controls__tabs">
            ...
            <a-card title="Marcador" class="controls__card controls__card--wide">
              <div class="controls__match">
                <div class="controls__side controls__side--local">
                  ...
                  <div v-if="sportModule.features.shots" class="controls__shot-rows">
        ...
        <a-tab-pane v-if="sportModule.features.shots || sportModule.features.roster" key="goals">
          <template #tab>
            Goles
            <a-badge
        ...
        <a-tab-pane v-if="sportModule.features.penalties" key="penalties" tab="Penalidades">
